...
// ==========================================
let lfData = [
  { id: 1, item: "Wireless Earbuds Case", category: "Electronics", type: "Found", date: "2026-07-19", status: "Pending", location: "Staff Common Room", description: "Black zip case with two wireless earbuds inside.", photo: "https://images.unsplash.com/photo-1590658268037-6bf12165a8df?auto=format&fit=crop&w=500&q=80" }
];;
