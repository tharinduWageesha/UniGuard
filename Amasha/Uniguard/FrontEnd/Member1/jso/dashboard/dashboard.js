/* JSO dashboard charts. Clock, icon rendering, sidebar toggle
   etc. are handled globally by assets/js/common.js. */
document.addEventListener("DOMContentLoaded", () => {
  ...
  const donutConfig = {
    labels: ["Patrol", "Gate Duty", "Incident Response"],
    data: [45, 40, 15],
    colors: ["#0088ff", "#10b981", "#ef4444"],
    cutout: 0.68,
    legendId: "distributionLegend",
  };

  ugRenderLineChart("trendsChart", trendConfig);
  ugRenderDonutChart("distributionChart", donutConfig);
